...
class SapiStreamEmitterTest extends SapiEmitterTest
{
    ...
    */
    private function setUpStreamProphecy($contents, $size, $startPosition, $trackPeakBufferLength = null)
    {
    ...
    {
        return array(
            array(true,   true,    '01234567890987654321',   10),
            array(true,   true,    '01234567890987654321',   20),
            array(true,   true,    '01234567890987654321',  100),
            array(true,   true, '01234567890987654321012',   10),
            array(true,   true, '01234567890987654321012',   20),
            array(true,   true, '01234567890987654321012',  100),
            array(true,  false,    '01234567890987654321',   10),
            array(true,  false,    '01234567890987654321',   20),
            array(true,  false,    '01234567890987654321',  100),
            array(true,  false, '01234567890987654321012',   10),
            array(true,  false, '01234567890987654321012',   20),
            array(true,  false, '01234567890987654321012',  100),
            array(false,  true,    '01234567890987654321',   10),
            array(false,  true,    '01234567890987654321',   20),
            array(false,  true,    '01234567890987654321',  100),
            array(false,  true, '01234567890987654321012',   10),
            array(false,  true, '01234567890987654321012',   20),
            array(false,  true, '01234567890987654321012',  100),
            array(false, false,    '01234567890987654321',   10),
            array(false, false,    '01234567890987654321',   20),
            array(false, false,    '01234567890987654321',  100),
            array(false, false, '01234567890987654321012',   10),
            array(false, false, '01234567890987654321012',   20),
            array(false, false, '01234567890987654321012',  100),
        );
    }
    ...
    {
        return array(
            array(true,   true, array('bytes', 10,  20, '*'),    '01234567890987654321',   5),
            array(true,   true, array('bytes', 10,  20, '*'),    '01234567890987654321',  10),
            array(true,   true, array('bytes', 10,  20, '*'),    '01234567890987654321', 100),
            array(true,   true, array('bytes', 10,  20, '*'), '01234567890987654321012',   5),
            array(true,   true, array('bytes', 10,  20, '*'), '01234567890987654321012',  10),
            array(true,   true, array('bytes', 10,  20, '*'), '01234567890987654321012', 100),
            array(true,   true, array('bytes', 10, 100, '*'),    '01234567890987654321',   5),
            array(true,   true, array('bytes', 10, 100, '*'),    '01234567890987654321',  10),
            array(true,   true, array('bytes', 10, 100, '*'),    '01234567890987654321', 100),
            array(true,   true, array('bytes', 10, 100, '*'), '01234567890987654321012',   5),
            array(true,   true, array('bytes', 10, 100, '*'), '01234567890987654321012',  10),
            array(true,   true, array('bytes', 10, 100, '*'), '01234567890987654321012', 100),
            array(true,  false, array('bytes', 10,  20, '*'),    '01234567890987654321',   5),
            array(true,  false, array('bytes', 10,  20, '*'),    '01234567890987654321',  10),
            array(true,  false, array('bytes', 10,  20, '*'),    '01234567890987654321', 100),
            array(true,  false, array('bytes', 10,  20, '*'), '01234567890987654321012',   5),
            array(true,  false, array('bytes', 10,  20, '*'), '01234567890987654321012',  10),
            array(true,  false, array('bytes', 10,  20, '*'), '01234567890987654321012', 100),
            array(true,  false, array('bytes', 10, 100, '*'),    '01234567890987654321',   5),
            array(true,  false, array('bytes', 10, 100, '*'),    '01234567890987654321',  10),
            array(true,  false, array('bytes', 10, 100, '*'),    '01234567890987654321', 100),
            array(true,  false, array('bytes', 10, 100, '*'), '01234567890987654321012',   5),
            array(true,  false, array('bytes', 10, 100, '*'), '01234567890987654321012',  10),
            array(true,  false, array('bytes', 10, 100, '*'), '01234567890987654321012', 100),
            array(false,  true, array('bytes', 10,  20, '*'),    '01234567890987654321',   5),
            array(false,  true, array('bytes', 10,  20, '*'),    '01234567890987654321',  10),
            array(false,  true, array('bytes', 10,  20, '*'),    '01234567890987654321', 100),
            array(false,  true, array('bytes', 10,  20, '*'), '01234567890987654321012',   5),
            array(false,  true, array('bytes', 10,  20, '*'), '01234567890987654321012',  10),
            array(false,  true, array('bytes', 10,  20, '*'), '01234567890987654321012', 100),
            array(false,  true, array('bytes', 10, 100, '*'),    '01234567890987654321',   5),
            array(false,  true, array('bytes', 10, 100, '*'),    '01234567890987654321',  10),
            array(false,  true, array('bytes', 10, 100, '*'),    '01234567890987654321', 100),
            array(false,  true, array('bytes', 10, 100, '*'), '01234567890987654321012',   5),
            array(false,  true, array('bytes', 10, 100, '*'), '01234567890987654321012',  10),
            array(false,  true, array('bytes', 10, 100, '*'), '01234567890987654321012', 100),
            array(false, false, array('bytes', 10,  20, '*'),    '01234567890987654321',   5),
            array(false, false, array('bytes', 10,  20, '*'),    '01234567890987654321',  10),
            array(false, false, array('bytes', 10,  20, '*'),    '01234567890987654321', 100),
            array(false, false, array('bytes', 10,  20, '*'), '01234567890987654321012',   5),
            array(false, false, array('bytes', 10,  20, '*'), '01234567890987654321012',  10),
            array(false, false, array('bytes', 10,  20, '*'), '01234567890987654321012', 100),
            array(false, false, array('bytes', 10, 100, '*'),    '01234567890987654321',   5),
            array(false, false, array('bytes', 10, 100, '*'),    '01234567890987654321',  10),
            array(false, false, array('bytes', 10, 100, '*'),    '01234567890987654321', 100),
            array(false, false, array('bytes', 10, 100, '*'), '01234567890987654321012',   5),
            array(false, false, array('bytes', 10, 100, '*'), '01234567890987654321012',  10),
            array(false, false, array('bytes', 10, 100, '*'), '01234567890987654321012', 100),
        );
    }
    ...
    {
        return array(
            array(true,   true,  1000,   20,       null,  512),
            array(true,   true,  1000,   20,       null, 4096),
            array(true,   true,  1000,   20,       null, 8192),
            array(true,  false,   100,  320,       null,  512),
            array(true,  false,   100,  320,       null, 4096),
            array(true,  false,   100,  320,       null, 8192),
            array(false,  true,  1000,   20,       null,  512),
            array(false,  true,  1000,   20,       null, 4096),
            array(false,  true,  1000,   20,       null, 8192),
            array(false, false,   100,  320,       null,  512),
            array(false, false,   100,  320,       null, 4096),
            array(false, false,   100,  320,       null, 8192),
            array(true,   true,  1000,   20,   array(25, 75),  512),
            array(true,   true,  1000,   20,   array(25, 75), 4096),
            array(true,   true,  1000,   20,   array(25, 75), 8192),
            array(false,  true,  1000,   20,   array(25, 75),  512),
            array(false,  true,  1000,   20,   array(25, 75), 4096),
            array(false,  true,  1000,   20,   array(25, 75), 8192),
            array(true,   true,  1000,   20, array(250, 750),  512),
            array(true,   true,  1000,   20, array(250, 750), 4096),
            array(true,   true,  1000,   20, array(250, 750), 8192),
            array(false,  true,  1000,   20, array(250, 750),  512),
            array(false,  true,  1000,   20, array(250, 750), 4096),
            array(false,  true,  1000,   20, array(250, 750), 8192),
        );
    }
    ...
    public function emitJsonResponseProvider()
    {
        return array(
            ...
            array(null                                                                        ),
            array(array(array(0.1, 0.2), array('test', 'test2'), array(true, false), array('key1' => 'value1'), array(null))),
        );
    }
    ...
    public function contentRangeProvider()
    {
        return array(
            ...
            array('items 0-0/1', 'Hello world', 'Hello world'),
        );
    }
